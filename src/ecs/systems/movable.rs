...
pub trait Movable {
    ...
    fn apply_move_on_all(controllable: &mut Vec<Option<Position>>, inputs: &Vec<Option<Input>>,map: &mut Array2D<Tile>, level_width: u16, level_height: u16, move_command: &MoveCommand, multiplier: i16) -> ();
}
...
impl Movable for Position {
    ...
    fn apply_move_on_all(positions: &mut Vec<Option<Position>>, inputs: &Vec<Option<Input>>,map: &mut Array2D<Tile>, level_width: u16, level_height: u16, move_command: &MoveCommand, multiplier: i16) -> () {
